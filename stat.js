...
//    WHILE LOOP
/* --> The while statement creates a loop that executes a specified statements as 
long as the test condition ecalutates to true.  */

//var n=15;
// while(n <= 25){
//     //BLOCK SCOPE
//     console.log(n);  //infinite loop
//     ++n
// }
...
// Write a programe to print table for given number.
